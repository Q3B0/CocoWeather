package com.example.jaylen.cocoweather.model;
...
import com.example.jaylen.cocoweather.database.CocoDatBaseHelper;
...
public class CocoWeatherDB {
    ...
    private CocoWeatherDB(Context context){
        CocoDatBaseHelper dbHelper = new CocoDatBaseHelper(context,
     ...
     * 获取CocoWeatherDB的实例
     */
    public synchronized  static CocoWeatherDB getInstence(Context context){
